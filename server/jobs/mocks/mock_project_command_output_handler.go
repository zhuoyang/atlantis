...
func (mock *MockProjectCommandOutputHandler) GetProjectOutputBuffer(jobID string) (jobs.OutputBuffer, bool) {
	if mock == nil {
		panic("mock must not be nil. Use myMock := NewMockProjectCommandOutputHandler().")
	}
	_params := []pegomock.Param{jobID}
	_result := pegomock.GetGenericMockFrom(mock).Invoke("GetProjectOutputBuffer", _params, []reflect.Type{reflect.TypeOf((*jobs.OutputBuffer)(nil)).Elem(), reflect.TypeOf((*bool)(nil)).Elem()})
